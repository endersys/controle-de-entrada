class SectorsController < ApplicationController
  ...
  before_action :set_unit_options, only: %i[ new create edit update ]
  ...
  private
    def set_unit_options
      @unit_options = Unit.all.pluck(:description, :id)
    end
    ...
    def sector_params
      params.require(:sector).permit(:description, :unit_id)
    end
end
