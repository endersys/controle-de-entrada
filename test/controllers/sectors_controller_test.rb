...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference("Sector.count") do
      post sectors_url, params: { sector: { description: @sector.description, unit_id: @sector.unit_id } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { description: @sector.description, unit_id: @sector.unit_id } }
